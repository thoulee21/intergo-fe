...
export default function AdminSessionDetailPage() {
  ...
  const displayInterviewParams = useMemo(() => {
    if (!sessionDetails?.interviewParams) return [];

    return Object.values(sessionDetails.interviewParams).filter(
      (p) => typeof p === "string",
    );
  }, [sessionDetails?.interviewParams]);
      ...
      >
        ...
        >
          ...
          <Descriptions.Item label="状态">
            {getStatusTag(sessionDetails.status)}
          </Descriptions.Item>
          <Descriptions.Item label="面试参数">
            {displayInterviewParams.join(", ")}
          </Descriptions.Item>
        </Descriptions>
      </Card>
